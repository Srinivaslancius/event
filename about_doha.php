					...
					<div class="container">
						<div class="row">			
								...
								<h2 class="sh-event-title">ABOUT <span>DOHA</span> and <span>venue</span></h2>
									...
									<p class="sh-ds col-md-12 col-xs-12"  style="line-height:28px">Stylish and modern, this Doha hotel is impressive in every detail, from the hotel lobby atrium to the open air rooftop pool. A wealth of luxury amenities include seven exciting and innovative dining and entertainment establishments.This Doha hotel is ideally located for business or leisure in the exclusive West Bay area, five minutes from Doha Exhibition and Convention Center, and close to Doha Golf Club, the City Centre Shopping Mall, and the more traditional Souq Waqif.</p>
									
										<div class="row noo-team-contents" style="margin-top:150px">
											<div class="col-md-6 col-sm-6">
												<div class="noo_team_item">
													<div class="team_thumbnail">
														<img src="images/doha_images/1.jpg" alt="team1"/>
														<div class="team-info">
															<h4 class="team_name">PRIME</h4>
														</div>
													</div>
													<div class="team-detail">
														<div class="team-detail-position">
															<p class="ds" style="text-align: justify">
																For guests passionate about steak multi award winning Prime is a bold, quality dining destination promising the finest selection of cuts consistently grilled and seasoned to perfection. Prime&#039;s relaxed and comfortable setting combined with its exquisite cuisine will make for a memorable dining experience.
															</p>
											...
											<div class="col-md-6 col-sm-6">
												<div class="noo_team_item">
													<div class="team_thumbnail">
														<img width="770" height="770" src="images/doha_images/2.jpg" alt="team2"/>
															<div class="team-info">
																<h4 class="team_name">SQUARE</h4>	
															</div>
													</div>
														<div class="team-detail">
															<div class="team-detail-position">
																<p class="ds"style="text-align: justify">
																	The Square is the ultimate dining destination. Join us for one of our theme nights, or better yet for our unique Bars Squared Friday Brunch with over 20 different bars, choose from our sushi bar, pasta bar, chocolate bar, burger bar and more. Take a trip around the world and visit our interactive kitchen specializing in International cuisine.
																</p>
																<div class="team_socials">
																	<span class="team_social">
																		<span class="social-name">Follow on facebook</span>
												...
												<div class="col-md-6 col-sm-6">
													<div class="noo_team_item">
														<div class="team_thumbnail">
															<img width="770" height="770" src="images/doha_images/3.jpg" alt="team3"/>
															<div class="team-info">
																<h4 class="team_name">Strata Restaurant and Lounge</h4>
														...
														<div class="team-detail">
															<div class="team-detail-position">
																<p class="ds" style="text-align: justify">
																	Located sky high on Levels 55 and 56 with stunning views of the Doha skyline, Strata Lounge offers a light menu with innovative creations best shared with friends and even better accompanied by our signature cocktails.
																</p>
																<div class="team_socials">
																	<span class="team_social">
																		<span class="social-name">Follow on facebook</span>
												...
												<div class="col-md-6 col-sm-6">
													<div class="noo_team_item">
														<div class="team_thumbnail">
															<img width="770" height="770" src="images/doha_images/4.jpg" alt="img4"/>
															<div class="team-info">
																<h4 class="team_name">Hwang</h4>
														...
														<div class="team-detail">
															<div class="team-detail-position">
																<p class="ds" style="text-align: justify">
																	In the casual yet inviting setting of our Pan Asian restaurant Hwang, you will enjoy true vibrant flavours of Southeast Asia. Our chefs invite you on a culinary journey of authentic flavors and signature dishes from across the region. Don&#039;t miss our signature Shabu shabu Japanese traditional hot pot.
																</p>
																<div class="team_socials">
																	<span class="team_social">
																		<span class="social-name">Follow on facebook</span>
												...
												<div class="col-md-6 col-sm-6">
													<div class="noo_team_item">
														<div class="team_thumbnail">
															<img width="770" height="770" src="images/doha_images/7.jpg" alt="team5"/>
															<div class="team-info">
																<h4 class="team_name">Lobby Lounge</h4>
														...
														<div class="team-detail">
															<div class="team-detail-position">
																<p class="ds" style="text-align: justify">
																	Relax in the spectacular surroundings of the hotel Lobby Lounge and enjoy a selection of classic savories, decadent patisseries and opulent afternoon tea options.  The modern and comfortable seating amidst the soaring lobby atrium makes for an ideal location for a meeting with friends or business partners.
																</p>
																<div class="team_socials">
																	<span class="team_social">
																		<span class="social-name">Follow on facebook</span>
												...
												<div class="col-md-6 col-sm-6">
													<div class="noo_team_item">
														<div class="team_thumbnail">
															<img width="770" height="770" src="images/doha_images/6.jpg" alt="team6"/>
															<div class="team-info">
																<h4 class="team_name">AL JALSA GARDEN LOUNGE</h4>
